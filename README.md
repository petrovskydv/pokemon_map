...
Для входа в админ-панель откройте [ссылку](http://127.0.0.1:8000/admin/) и введите логин и пароль вашего нового суперпользователя.
На этой странице вы можете внести данные о покемонах (раздел `Pokemons`) и местах их появления (раздел `Pokemon entitys`). Обязательные для заполнения поля выделены жирным шрифтом.
